    ...
    <div className="overflow-hidden border-y border-border bg-card/[0.72]">
      {teams.map((team) => (
        <Link
          ...
          className="group grid gap-3 border-b border-border px-4 py-4 transition last:border-b-0 hover:bg-accent md:grid-cols-[1fr_180px_44px] md:items-center"
        >
          ...
          <div className="hidden justify-end md:flex">
            <div className="flex h-9 w-9 items-center justify-center rounded-md text-muted-foreground transition group-hover:bg-card group-hover:text-primary">
