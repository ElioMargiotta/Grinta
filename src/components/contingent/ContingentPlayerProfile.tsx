      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div className="flex min-w-0 items-center gap-4">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-lg bg-primary text-lg font-semibold text-primary-foreground">
          ...
          <div className="grid grid-cols-3 gap-3 md:min-w-[360px]">
            <div className="rounded-md border border-border px-3 py-2">
              ...
              <div className="text-[11px] text-muted-foreground">{t("stats.teams")}</div>
            </div>
            <div className="rounded-md border border-border px-3 py-2">
              <div className="font-mono text-lg font-semibold tabular-nums text-foreground">
                {evaluations.length}
              </div>
              <div className="text-[11px] text-muted-foreground">{t("stats.reports")}</div>
            </div>
            <div className="rounded-md border border-border px-3 py-2">
              <div className="font-mono text-lg font-semibold tabular-nums text-foreground">
                {pendingInvitations.length}
              </div>
              <div className="text-[11px] text-muted-foreground">{t("stats.invites")}</div>
            </div>
          </div>
        </div>

        <div className="mt-5 grid gap-4 border-t border-border pt-4 sm:grid-cols-4">
